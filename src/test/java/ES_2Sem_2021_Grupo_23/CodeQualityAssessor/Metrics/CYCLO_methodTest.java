...
class CYCLO_methodTest {
	...
	void GrammarException() {
		...
		expectedCyclos
				.add(new Triplet<String, String, Integer>("GrammerException", "GrammerException(int, String)", 1));
		expectedCyclos.add(
				new Triplet<String, String, Integer>("GrammerException", "GrammerException(int, int, int, String)", 1));
		expectedCyclos.add(
				new Triplet<String, String, Integer>("GrammerException", "GrammerException(String, Exception)", 1));
		expectedCyclos
				.add(new Triplet<String, String, Integer>("GrammerException", "GrammerException(int, int, String)", 1));
	...
	void ParsingException() {
		...
		List<Triplet<String, String, Integer>> expectedCyclos = new ArrayList<Triplet<String, String, Integer>>();
		expectedCyclos.add(
				new Triplet<String, String, Integer>("ParsingException", "ParsingException(int, int, int, String)", 1));
		expectedCyclos
				.add(new Triplet<String, String, Integer>("ParsingException", "ParsingException(int, int, String)", 1));
		expectedCyclos
				.add(new Triplet<String, String, Integer>("ParsingException", "ParsingException(int, String)", 1));
		expectedCyclos.add(
				new Triplet<String, String, Integer>("ParsingException", "ParsingException(String, Exception)", 1));
	...
	void SourceCodeParser() {
		...
		List<Triplet<String, String, Integer>> expectedCyclos = new ArrayList<Triplet<String, String, Integer>>();
		expectedCyclos
				.add(new Triplet<String, String, Integer>("OpcodeWrapper", "OpcodeWrapper(Attribute_Code.Opcode)", 1));
		expectedCyclos.add(
				new Triplet<String, String, Integer>("OpcodeWrapper", "OpcodeWrapper(int, byte, byte[][], Object)", 1));
		expectedCyclos.add(new Triplet<String, String, Integer>("LabeledInstructions",
				"LabeledInstructions(Attribute_Code.Opcode[], Hashtable, int)", 1));
		...
		expectedCyclos.add(new Triplet<String, String, Integer>("SourceCodeParser",
				"parseMethodAttributes(Method, ArrayList, LabeledInstructions, Attribute_Code, ArrayList)", 10));
		expectedCyclos.add(new Triplet<String, String, Integer>("SourceCodeParser", "parseLineNumbers(String)", 1));
		expectedCyclos
				.add(new Triplet<String, String, Integer>("SourceCodeParser", "parseMethodInstructions(Method)", 128));
		expectedCyclos.add(
				new Triplet<String, String, Integer>("SourceCodeParser", "updateLabelLinks(Hashtable, ArrayList)", 26));
		expectedCyclos.add(new Triplet<String, String, Integer>("SourceCodeParser",
				"parseMethodSignature(Method, ArrayList)", 11));
		expectedCyclos.add(new Triplet<String, String, Integer>("SourceCodeParser",
				"parseLocalVariableTable(String, Hashtable)", 12));
		expectedCyclos.add(
				new Triplet<String, String, Integer>("SourceCodeParser", "parseExceptionTable(String, Hashtable)", 15));
		expectedCyclos.add(
				new Triplet<String, String, Integer>("SourceCodeParser", "getOffset(String, Hashtable, boolean)", 3));
		...
		expectedCyclos.add(
				new Triplet<String, String, Integer>("SourceCodeParser", "parseMaxStackOrLocals(Attribute_Code)", 7));
