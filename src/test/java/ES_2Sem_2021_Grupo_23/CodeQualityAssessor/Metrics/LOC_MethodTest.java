...
class LOC_MethodTest {
	...
	void GrammarException() {
		...
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("GrammerException", "GrammerException(int, String)", 3));
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("GrammerException", "GrammerException(int, int, int, String)", 3));
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("GrammerException", "GrammerException(String, Exception)", 3));
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("GrammerException", "GrammerException(int, int, String)", 3));
	...
	void ParsingException() {
		...
		List<Triplet<String, String, Integer>> expectedMethodLines = new ArrayList<Triplet<String, String, Integer>>();
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("ParsingException", "ParsingException(int, int, int, String)", 6));
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("ParsingException", "ParsingException(int, int, String)", 5));
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("ParsingException", "ParsingException(int, String)", 4));
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("ParsingException", "ParsingException(String, Exception)", 3));
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("ParsingException", "ParsingException(String)", 3));
	...
	void SourceCodeParser() {
		...
		List<Triplet<String, String, Integer>> expectedMethodLines = new ArrayList<Triplet<String, String, Integer>>();
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("OpcodeWrapper", "OpcodeWrapper(Attribute_Code.Opcode)", 5));
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("OpcodeWrapper", "OpcodeWrapper(int, byte, byte[][], Object)", 4));
		expectedMethodLines.add(new Triplet<String, String, Integer>("LabeledInstructions",
				"LabeledInstructions(Attribute_Code.Opcode[], Hashtable, int)", 5));
		expectedMethodLines.add(new Triplet<String, String, Integer>("SourceCodeParser", "SourceCodeParser(File)", 3));
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("SourceCodeParser", "SourceCodeParser(String)", 3));
		expectedMethodLines.add(new Triplet<String, String, Integer>("SourceCodeParser", "parse()", 9));
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("SourceCodeParser", "preprocessConstantValues()", 20));
		...
		expectedMethodLines.add(new Triplet<String, String, Integer>("SourceCodeParser",
				"parseMethodAttributes(Method, ArrayList, LabeledInstructions, Attribute_Code, ArrayList)", 48));
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("SourceCodeParser", "parseLineNumbers(String)", 3));
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("SourceCodeParser", "parseMethodInstructions(Method)", 523));
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("SourceCodeParser", "updateLabelLinks(Hashtable, ArrayList)", 58));
		expectedMethodLines.add(new Triplet<String, String, Integer>("SourceCodeParser",
				"parseMethodSignature(Method, ArrayList)", 59));
		expectedMethodLines.add(new Triplet<String, String, Integer>("SourceCodeParser",
				"parseLocalVariableTable(String, Hashtable)", 61));
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("SourceCodeParser", "parseExceptionTable(String, Hashtable)", 66));
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("SourceCodeParser", "getOffset(String, Hashtable, boolean)", 11));
		...
		expectedMethodLines.add(
				new Triplet<String, String, Integer>("SourceCodeParser", "parseMaxStackOrLocals(Attribute_Code)", 23));
		...
		expectedMethodLines
				.add(new Triplet<String, String, Integer>("SourceCodeParser", "exception(Scanner, String)", 3));
