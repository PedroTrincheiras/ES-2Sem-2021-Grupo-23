...
class CalculateIndicatorsTest {
	...
	void getIndicatorsMethodTest() throws IOException {
		...
		List<Pair<String, String>> indicators = CalculateIndicators.getIndicators(directory, rule, ruleName);
		List<Pair<String, String>> expectedIndicators = new ArrayList<Pair<String, String>>();
		expectedIndicators.add(new Pair<String, String>("1", "VN"));
		expectedIndicators.add(new Pair<String, String>("2", "VN"));
		expectedIndicators.add(new Pair<String, String>("3", "VN"));
		expectedIndicators.add(new Pair<String, String>("4", "VN"));
		expectedIndicators.add(new Pair<String, String>("5", "VN"));
		expectedIndicators.add(new Pair<String, String>("6", "VN"));
		expectedIndicators.add(new Pair<String, String>("7", "VN"));
		expectedIndicators.add(new Pair<String, String>("8", "VN"));
		expectedIndicators.add(new Pair<String, String>("9", "VN"));
		expectedIndicators.add(new Pair<String, String>("10", "VN"));
